...
class PairwiseSumTest {
    ...
    void pairwiseSum5() {
        for (int i = 0; i < nbrTests; i++) {
            Assertions.assertArrayEquals(new int[]{i + i, i + i, i + i}, PairwiseSum.pairwiseSum(new int[]{i, i, i, i}));
            int r = random.nextInt(20);
            int r2 = random.nextInt(10);
            int r3 = random.nextInt(30);
            Assertions.assertArrayEquals(new int[]{i + r, r + r2, r2 + r3}, PairwiseSum.pairwiseSum(new int[]{i, r, r2, r3}));
        }
    }

    @Test
    void pairwiseSum6() {
        Assertions.assertArrayEquals(new int[]{3, 5, 7, 9, 13, 17}, PairwiseSum.pairwiseSum(new int[]{1, 2, 3, 4, 5, 8, 9}));
    }
